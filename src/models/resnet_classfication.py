...
class CustomImageDataset(Dataset):
    def __init__(self, images_dir, labels_dir, transform=None, label_type='respiratory_condition'):
...
def train():
    ...
    train_dataset = CustomImageDataset(
        images_dir=r'D:\Download\coughvid_filtered\coughvid_images\trainsub',
        labels_dir=r'D:\Download\coughvid_filtered\coughvid_labels\train_sub',
        transform=train_transform,
        label_type='respiratory_condition'
    )
    val_dataset = CustomImageDataset(
        images_dir=r'D:\Download\coughvid_filtered\coughvid_images\val',
        labels_dir=r'D:\Download\coughvid_filtered\coughvid_labels\val',
